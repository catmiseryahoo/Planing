...
- ссылку на инструкцию [Администратор организации: Telegram-уведомления и канал организации](telegram-organization-admin.md).

Username общего бота показывается пользователям в личном кабинете. Если username бота меняется, обновите переменную фронтенда `VITE_TELEGRAM_BOT_USERNAME` и заново задеплойте приложение.
